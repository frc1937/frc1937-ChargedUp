...
public class ToggleIntake extends CommandBase {
  ...
  private final boolean intakeUp = m_intake.getIsIntakeUp();
  ...
  */
  ...
  public void initialize() {
    if (intakeUp) {
      m_intake.setIntakePosition(IntakeConstants.MINIMUM_POSITION);
      m_intake.openIntake();
      m_intake.setIntakeWheelSpeed(speed);
    } else {
      m_intake.setIntakePosition(IntakeConstants.MAXIMUM_POSITION);
